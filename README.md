...
```json
{
  ...
  "nodes": [
    {
      "parameters": {
        ...
        "folderToWatch": {
          "__rl": true,
          "value": "13Djk9EAYcWPQ1KT5skMTWn4yLgHeUzMw",
          "mode": "id"
        },
        "event": "fileCreated",
        "options": {}
      ...
      "id": "0b58f599-7a07-48b9-96fb-3845108050be",
    ...
    },
    {
      "parameters": {
        "conditions": {
          ...
          "conditions": [
            {
              "id": "5d6aa78b-c270-41dc-a39f-70bb120d6fb1",
              "leftValue": "={{$node[\"Google Drive Trigger\"].json.name.split('.').pop().toLowerCase()}}",
              "rightValue": "webp",
              "operator": {
                "type": "string",
                "operation": "notEquals"
            ...
            {
              "id": "f926dba0-7689-42c0-a8ca-e87e4d7cdb51",
              "leftValue": "={{$node[\"Google Drive Trigger\"].json.name.split('.').pop().toLowerCase()}}",
              "rightValue": "mp4",
              "operator": {
                "type": "string",
      ...
      "id": "cb30b84e-98ae-4dd5-a923-03ceb3c49ab8",
      "name": "IsnotVideo?"
    },
    {
      "parameters": {
      ...
      "id": "86bc0333-d211-497e-8d15-a848d916bdb3",
      "name": "Google Drive",
      "credentials": {
        "googleDriveOAuth2Api": {
          "id": "J7noNRzf26R3DpFF",
    ...
    },
    {
      ...
      "id": "48677e91-9f47-4754-8be4-fc912c9e4d05",
      "name": "No Operation, do nothing"
    },
    {
      "parameters": {
        "content": "## Deletes the images as soon as they are uploaded to the folder",
        "height": 140,
        "color": 3
      },
      ...
      "id": "e91a8995-46ce-4be8-b928-f396f3d2e7c2",
      "name": "Sticky Note"
    }
  ],
  "pinData": {},
  ...
  "versionId": "588422fd-7e24-471b-ae8a-2561625bf7c3",
  "meta": {
